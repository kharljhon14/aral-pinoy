...
export default function Features() {
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      <div className="flex flex-col gap-y-6 bg-teal-200 p-12 rounded-2xl">
      ...
      <div className="flex flex-col gap-y-6 bg-amber-200 p-12 rounded-2xl">
      ...
      <div className="flex flex-col gap-y-6 bg-pink-200 p-12 rounded-2xl">
