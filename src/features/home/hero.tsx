...
export default function Hero() {
  return (
    <motion.div
      ...
      className="bg-radial from-white via-pink-100 to-purple-200 rounded-xl lg:py-16 lg:px-24 px-12 py-10"
    >
      ...
      <div className="flex items-center justify-center gap-8 lg:my-24 my-10">
